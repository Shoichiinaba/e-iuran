    ...
    <ul class="nav">
        ...
        <?php if ($userdata->role == 'RT') : ?>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="tagihan">
                    ...
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="<?php echo site_url('Data_tagihan/data_transaksi'); ?>">Data Transaksi</a>
                        </li>
                    </ul>
                    <ul class="nav flex-column sub-menu">
        ...
        <?php if ($userdata->role == 'Admin') : ?>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="iuran">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="<?php echo site_url('Data_iuran/nama_iuran'); ?> ">Nama
                                Iuran</a>
                        </li>
                    </ul>
                </div>
