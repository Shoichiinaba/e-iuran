                ...
                <a href="<?php echo site_url('Auth/logout'); ?> ">
                    <li class="more-button-list-item">
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="576.002px"
                            height="576.002px" viewBox="0 0 576.002 576.002"
                            style="enable-background:new 0 0 576.002 576.002;" xml:space="preserve">
                            <g>
                                <g id="Share">
                                    <g>
                                        <path
                                            d="M504.001,468.002c0,19.872-16.128,36-36,36h-360c-19.872,0-36-16.128-36-36v-360c0-19.872,16.128-36,36-36h108
...
<div div class="d-lg-none">
    <center>
        <div class="list-container">
            ...
            <ul class="more-button-list">
                <a href="<?php echo site_url('Pembayaran_cash'); ?> ">
                    <li class="more-button-list-item">
