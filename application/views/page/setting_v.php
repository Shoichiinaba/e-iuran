...
<div class="main-panel">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <p class="card-title">Pengaturan API Xendit</p>
                            <button type="button"
                                class="btn btn-social-icon-text btn-twitter btn-sm ml-auto mb-2 text-center"
                                data-bs-toggle="modal" data-bs-target="#exampleModal"><i class=" ti-rss mr-1"></i>Tambah
                                API</button>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="table-responsive">
                                    <table id="api-xendit" class="display expandable-table" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Nama</th>
                                        ...
                                        <tbody>
                                            <?php $no= 0; foreach ($setting as $data ): $no++;?>
                                            <tr>
                                                <td><?php echo $no; ?></td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body pt-1 pl-2 pr-2 pb-1">
                    <form method="post" action="<?php echo base_url('Setting_xendit/simpan_api'); ?>">
                        <div class="input-group mb-3">
                            <button class="btn btn-warning" type="button" id="button-addon1"><b
                                    class="ti-server"></b></button>
                            <input type="text" class="form-control" name="name[]" required placeholder="Nama Key"
                                aria-label="Nama Key" aria-describedby="button-addon2">
                        </div>
                        <div class="input-group mb-3">
                            <button class="btn btn-warning" type="button" id="button-addon1"><b
                                    class="ti-server"></b></button>
                            <input type="text" class="form-control" name="value[]" required placeholder="Value Key"
                                aria-label="Masukan Value" aria-describedby="button-addon2">
                        </div>
    ...
    <!-- Modal edit perum -->
    <?php $no=  0; foreach($setting as $g  ): $no++;?>
    <div class="modal fade" id="modal-edit<?=$g->id;?>" tabindex="-1" aria-labelledby="exampleModaledit"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModaledit">Edit API</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body pt-1 pl-2 pr-2 pb-1">
                    <form method="post" action="<?php echo base_url('Setting_xendit/edit_api'); ?>">
                        <div class="input-group mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="name" value="<?=$g->name;?>" required
                                placeholder="Nama Key" aria-label="Nama Key" aria-describedby="button-addon2">
                        </div>
                        <div class="input-group mb-3">
                            <button class="btn btn-warning" type="button" id="button-addon1"><b
                                    class="ti-server"></b></button>
                            <input type="text" class="form-control" name="value" value="<?=$g->value;?>" required
                                placeholder="Value Key" aria-label="Masukan Value" aria-describedby="button-addon2">
                        </div>
                        <div class="modal-footer pr-0">
                            <button type="submit" class="btn btn-primary">Simpan</button>
                        </div>
    ...
    $(document).ready(function() {
        window.crud = $('#api-xendit').DataTable({
            "paging": true,
            "ordering": true,
            "autoWidth": true,
            "responsive": true,
    ...
    function confirmDelete(id) {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = '<?php echo site_url('Setting_xendit/hapus/'); ?>' + id;
