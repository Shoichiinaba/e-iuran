                            ...
                            <div class="form-group mt-3 col-lg-12 col-md-12 col-sm-12 col-xs-12 mr-0">
                                ...
                                <select class="js-example-basic-single w-100" id="id_warga" name="id_warga" required>
                                    ...
                                    <?php foreach ($warga as $data) { ?>
                                        <option value="<?= $data['id']; ?>" data-badge="<?= $data['badge']; ?>" data-no-rumah="<?= $data['no_rumah']; ?>" data-kapling-gabungan="<?= $data['kapling_gabungan']; ?>">
                                            <?= $data['text']; ?>
                                        </option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="card-body pb-2 pr-2">
                                ...
                                <div class="input-group pb-0">
                                    ...
                                    <div class="col-lg-2 col-md-6 col-sm-12 col-xs-12 mt-1 mb-2 p-0" hidden>
                                        <div class="input-wrapper">
                                            ...
                                            <input type="text" id="id-rtrw" value="<?php echo $userdata->id_rtrw; ?>" class="col-lg-12">
                                        </div>
                                    </div>
                                    ...
                                    <?php foreach ($ifas as $data) { ?>
                                        <div class="col-lg-2 col-md-6 col-sm-12 col-xs-12  mt-1 mb-2 p-0" hidden>
                                            <div class="input-wrapper">
                                                <input type="text" id="lain-lain" class="col-lg-12" value="<?= $data->nominal; ?>">
                                            </div>
                                        </div>
                                    <?php } ?>
                                    ...
                                    <?php foreach ($tax as $data) { ?>
                                        <div class="col-lg-2 col-md-6 col-sm-12 col-xs-12  mt-1 mb-2 p-0" hidden>
                                            <div class="input-wrapper">
                                                <input type="text" id="taxs" class="col-lg-12" value="<?= $data->tax_amaunt; ?>">
                                            </div>
                                        </div>
                                    <?php } ?>
                                    ...
                                    <?php foreach ($iuran as $data) { ?>
                                        ...
                                        <div class="col-lg-2 col-md-6 col-sm-12 col-xs-12  mt-1 mb-2 p-0" hidden>
                                            <div class="input-wrapper">
                                                ...
                                                <input type="text" id="harga1" class="col-lg-12" value="<?= $data->nominal1; ?>">
                                                <label class="label-in">harga / kubik</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-2 col-md-6 col-sm-12 col-xs-12  mt-1 mb-2 p-0" hidden>
                                            <div class="input-wrapper">
                                                <input type="text" id="perawatan" class="col-lg-12" value="<?= $data->perawatan; ?>">
                                ...
                                <div class="demo">
                                    <button type="submit" class="btn btn-outline-success btn-icon-text" id="btn-buat">
                                        ...
                                        <span id="loading-icon-buat" class="loading" style="display: inline-block; float: left; display:none;">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" width="24" height="24" style="shape-rendering: auto; display: block; background: rgb(255, 255, 255, 0);
" xmlns:xlink="http://www.w3.org/1999/xlink">
                                                        ...
                                                        <g transform="scale(0.7)">
                                                            <g transform="translate(-50 -50)">
                                                                <g>
                                                                    ...
                                                                    <path d="M50 50L50 0A50 50 0 0 1 100 50Z" fill="#e15b64" fill-opacity="0.8"></path>
                                                                </g>
                                                                <g>
                                                                    ...
                                                                    <path transform="rotate(90 50 50)" d="M50 50L50 0A50 50 0 0 1 100 50Z" fill="#f47e60" fill-opacity="0.8"></path>
                                                                </g>
                                                                <g>
                                        ...
                                        <span style="display: inline-block; float: right; display:none;" class="pt-1 pl-1 loading-text">Loading...</span>
                                    </button>
