...
<div class="main-panel">
                                                ...
                                                <div class="d-flex flex-row align-items-right">
                                                    <svg height="40px" width="40px" version="1.1" id="Layer_1"
                                                        ...
                                                        <circle style="fill:#FF507D;" cx="290.712" cy="160.542"
                                                            r="39.051" />
                                                        <circle style="fill:#FFC850;" cx="342.78" cy="160.542"
                                                            r="39.051" />
                                                    ...
                                                    <div class="ms-1 mt-0">
                                                        ...
                                                        <h6 class="card-title text-info pt-1 mt-0"
                                                            style="font-size: 15px;" id="saldo-deposit"></h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body pt-3 pl-2 pr-2 pb-1">
                    <form id="input-deposit" enctype="multipart/form-data">
                        <div class="input-group pb-0">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-1 mb-2 p-0">
                                <div class="input-wrapper">
                                    <input type="text" id="no-depo" class="col-lg-12" required>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-2 mb-2 p-0">
                                <div class="input-wrapper">
                                    <textarea id="keterangan" class="col-lg-12" required></textarea>
                                    <label class="label-in">Keterangan</label>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-0 mb-0 p-0">
    ...
    $(document).ready(function() {
        ...
        $('#input-deposit').submit(function(event) {
            ...
            formData.append('no_depo', $('#no-depo').val());
