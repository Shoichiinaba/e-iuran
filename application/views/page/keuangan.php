                        ...
                        <div class="row">
                            <div class="template-demo col-lg-4 col-md-4 pt-2 mb-1">
                                <div class="grid-margin pt-2 mb-2 pb-2">
                                    <button type="button" class="btn btn-outline-info btn-sm mr-2 pr-2 shadow" data-bs-toggle="modal" data-bs-target="#penerimaan">
                                ...
                                <div class="grid-margin pt-2 mb-2 pb-2">
                                    <button type="button" class="btn btn-outline-success btn-sm ml-2 pl-2 shadow" data-bs-toggle="modal" data-bs-target="#pembayaran">
                                        <svg id="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="50px" height="50px">
                            ...
                            <div class="pt-2 mb-6 col-md-8 col-lg-8 col-sm-8 d-flex flex-column flex-md-row justify-content-end">
                                    ...
                                    <div class="card d-flex align-items-left shadow-lg">
                                        <div class="card-body pl-2 ml-2 pr-1 mr-1 mb-0 pb-0">
                                            <div class="d-flex flex-row align-items-right">
                                                <img src="<?php echo base_url(); ?>assets/images/icon/wallet.ico" alt="icon" style="width: 40px; height: 40px;" />
                                                <div class="ms-1 mt-0">
                                                    <b class="mt-0 text-info card-text">Saldo Bulan Lalu</b>
                                                    <h6 class="card-title text-info pt-1 mt-0" style="font-size: 15px;" id="saldo-sebelumnya">
                                                    </h6>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 grid-margin pt-2 pt-2 pl-0 pr-1 pb-1 mb-1">
                                    <a href="<?php echo site_url('Data_cash'); ?> " style="text-decoration: none;">
                                        <div class="card d-flex align-items-left shadow-lg">
                                            <div class="card-body pl-2 ml-2 pr-1 mr-1 mb-0 pb-0">
                                                <div class="d-flex flex-row align-items-right">
                                                    ...
                                                    <div class="ms-1 mt-0">
                                                        ...
                                                        <h6 class="card-title text-success pt-1 mt-0" style="font-size: 15px;" id="saldo-cash"></h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 grid-margin pt-2 pt-2 pl-0 pr-1">
                                    <a href="<?php echo site_url('Data_hutang'); ?> " style="text-decoration: none;">
                                        <div class="card d-flex align-items-left shadow-lg">
                                            <div class="card-body pl-2 ml-2 pr-1 mr-1 mb-0 pb-0">
                                                <div class="d-flex flex-row align-items-right">
                                                    <svg height="40px" width="40px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 490.358 490.358" xml:space="preserve">
                                                        <g>
                                                            <g>
                                                    ...
                                                    <div class="ms-1 mt-0">
                                                        ...
                                                        <h6 class="card-title text-danger pt-1 mt-0" style="font-size: 15px;" id="saldo-hutang"></h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-12 pr-0 mr-0">
                                    <div class="row mb-2">
                                        <div class="col-lg-2 col-xxl-2 col-md-3">
                                            <div class="input-group input-group-sm filter">
                                                <span class="input-group-text text-body bg-gradient-primary">
                                                    <i class="fa fa-id-card-o" style="color:white;" aria-hidden="true"></i>
                                                </span>
                                        ...
                                        <div class="col-lg-3 col-xxl-2 col-md-3 col-sm-12 mb-2">
                                            <div class="input-group input-group-sm filter">
                                                ...
                                                <input type="text" class="form-control" id="fil-daterange" name="fil_daterange" placeholder=" Pilih Range Tanggal">
                                            </div>
                                        </div>
                                        <div class="col-lg-2 col-xxl-2 col-md-3">
                                    ...
                                    <div class="table-responsive">
                                        <table id="data-keuangan" class="display expandable-table" style="width:100%">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <th colspan="7" class="bg-primary text-right text-light" style="font-weight: bold;">Saldo akhir: &nbsp;
                                                    </th>
                                                    <th></th>
                                                </tr>
                                            </tfoot>
