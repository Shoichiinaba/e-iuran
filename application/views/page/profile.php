                    ...
                    <div class="card-body">
                        <div class="d-sm-flex flex-row flex-wrap text-center text-sm-left align-items-center">
                            ...
                            <div class="ms-sm-3 ms-md-0 ms-xl-3 mt-2 mt-sm-0 mt-md-2 mt-xl-0">
                                ...
                                <p>
                                <h5 class="mb-0 text-success font-weight-bold text-center">
                                    <?php echo $userdata->username; ?></h5>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="nav-tabs-custom pb-0 mb-0">
                            ...
                            <div class="tab-content pb-0 mb-0 mt-1 pt-2">
                                <div class="active tab-pane" id="settings">
                                    <form class="form-horizontal" action="<?php echo base_url('Profile_adm/update') ?>"
                                ...
                                <div class="tab-pane" id="password">
                                    <form class="forms-sample"
                                        action="<?php echo base_url('Profile_adm/ubah_password') ?>" method="POST">
                                        <div class="form-group row pb-0 mb-0">
                                            <div class="col-sm-9">
